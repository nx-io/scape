...
public class TaskController extends BaseController {
	...
	@RequestMapping(value = "/detail/{taskId}", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/my_apply_task", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
    ...
    @RequestMapping(value = "/my_publish_task", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
    @ResponseBody
