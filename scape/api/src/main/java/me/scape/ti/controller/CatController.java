...
public class CatController extends BaseController {
	...
	@RequestMapping(value = "/item/cat", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
	public ResponseEntity<String> cat() {
		return toResponse(catService.getAllCat());
	}

	@RequestMapping(value = "/item/area", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
	public ResponseEntity<String> area() {
		return toResponse(catService.getAllAreaCat());
	}

	@RequestMapping(value = "/item/style", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
