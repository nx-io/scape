...
public class PlantController extends BaseController {
	...
	@RequestMapping(value = "/plant/detail/{plantId}", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/plant/search", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/plant/cats", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/plant/colors", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/plant/periods", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
