...
public class CommonController extends BaseController {
	...
	@RequestMapping(value = "/file/upload", produces = "application/json;charset=UTF-8", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/version/android", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/version/ios", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/commons/provinces", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/commons/city/{provinceId}", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/commons/region/{cityId}", produces = "application/json;charset=UTF-8", method = RequestMethod.GET)
	@ResponseBody
