...
public class CommonController extends BaseController {
	...
	@RequestMapping(value = "/version/android", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/version/ios", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/commons/provinces", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/commons/city/{provinceId}", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/commons/region/{cityId}", produces = "application/json", method = RequestMethod.GET)
	@ResponseBody
