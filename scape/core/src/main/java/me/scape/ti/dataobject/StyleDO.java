...
@NamedQueries({ @NamedQuery(name = "StyleDO.getStylesByIds", query = "FROM StyleDO WHERE id IN :ids"), @NamedQuery(name = "StyleDO.getAllStyles", query = "FROM StyleDO WHERE display != -1") })
public class StyleDO implements Serializable {

	private static final long serialVersionUID = -6037842641271532756L;
